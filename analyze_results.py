...
<head>
    ...
    <style>
        ...
        .stat-card p {{ margin: 10px 0 0; font-size: 24px; font-weight: bold; color: #2196F3; }}
        ...
        .progress-fill {{ height: 100%; background-color: #2196F3; transition: width 0.3s ease; }}
    </style>
    <script>
    ...
    <div class="container">
        ...
        <div class="stats">
            ...
            <div class="stat-card">
                ...
                <p class="success">{stats['successful_tasks']}</p>
            </div>
            <div class="stat-card">
                <h3>Failed Tasks</h3>
                <p class="failure">{stats['failed_tasks']}</p>
            </div>
            <div class="stat-card">
                <h3>Success Rate</h3>
                <p>{stats['success_rate']:.1f}%</p>
            </div>
            <div class="stat-card">
                <h3>Incomplete Tasks</h3>
                <p class="incomplete">{stats['incomplete_tasks']}</p>
            </div>
        </div>
