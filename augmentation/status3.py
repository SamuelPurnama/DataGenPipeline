...
MAX_AUGMENT = 7  # Set to None for no limit
...
def augment_instructions(
    ...
    system_prompt = (
        ...
        "and 'explanation' (briefly describe how you determined whether the instructions matched and how you rewrote them if needed).\n\n"
